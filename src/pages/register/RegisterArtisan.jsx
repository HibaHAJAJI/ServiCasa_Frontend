            ...
            <div className="form-group">
              ...
              <div className="input-wrapper">
                ...
                <input
                  ...
                  className={
                    errors.anneesExperience ? "input-error" : ""
                  }
                />
              </div>
            ...
            <div className="form-group">
              ...
              <div className="input-wrapper">
                ...
                <input
                  ...
                  className={
                    errors.tarifHoraire ? "input-error" : ""
                  }
                />
              </div>
            ...
            <div className="form-group">
              ...
              <div className="input-wrapper">
                ...
                <input
                  ...
                  className={
                    errors.zoneIntervention ? "input-error" : ""
                  }
                />
              </div>

              {errors.zoneIntervention && (
                <span className="error-text">
                  {errors.zoneIntervention.message}
                </span>
              )}
            </div>
